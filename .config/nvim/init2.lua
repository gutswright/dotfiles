...
-- vim.o.guifont = "Source Code Pro:h54"
...
require("lazy").setup({
	...
	"echasnovski/mini.nvim", -- For mini.files plugins
	...
	--
	{
		...
		dependencies = {
			"nvim-treesitter/nvim-treesitter", -- Required for treesitter grammar support
			"nvim-telescope/telescope.nvim", -- Optional for class previewer
			"neovim/nvim-lspconfig", -- Optional for auto tailwindcss-language-server setup
		},
		opts = {
			server = {
			...
			document_color = {
				enabled = true,
				kind = "inline", -- Inline color hints (requires Neovim 0.10+)
			},
			conceal = {
				enabled = false, -- Set to `true` to enable class concealing
			},
		},
