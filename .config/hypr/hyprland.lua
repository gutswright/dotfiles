...
general { 
    ...
    # col.active_border = rgb(500724) rgb(881337) 45deg
...
bind = $mainMod, F, exec, firefox-developer-edition || firefox-devedition
bind = $mainMod Alt_r Control_L Shift_R, G, exec, chromium --force-device-scale-factor=1.3 
bind = $mainMod, D, exec, chromium --app=https://draw.rk4.dev --force-device-scale-factor=1.6 &

bind = $mainMod, Q, exec, $terminal
bind = $mainMod, Z, exec, $terminal
# bind = $mainMod, Z, exec, zen-browser & 
bind = $mainMod Alt_r Control_L Shift_R, Z, exec, $terminal 
...
bind = $mainMod, M, exec, dms ipc call bar toggle index 0

bind = $mainMod, E, exec, $fileManager
# bind = $mainMod, V, exec, cliphist list | tofi | cliphist decode | wl-copy # clipboard history
bind = $mainMod Alt_r Control_L Shift_R, V, exec, cliphist list | tofi | cliphist decode | wl-copy # clipboard history
bind = $mainMod, R, exec, $(tofi-drun) # app runner
bind = $mainMod, T, togglefloating,
# bind = $mainMod, P, pseudo, # dwindle

bind = $mainMod, O, layoutmsg, togglesplit # orthogonal
bind = $mainMod, J, layoutmsg, togglesplit
# bind = $mainMod, O, togglesplit, # orthogonal
...
bind = $mainMod, apostrophe, workspace, +1
...
# Fullscreen toggle
bind = Shift_L Alt_L, F, fullscreen
