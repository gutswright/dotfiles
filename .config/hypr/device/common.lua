...
hl.bind(main_mod .. ' + E', hl.dsp.exec_cmd 'dms ipc call spotlight toggleWith files', { description = 'Search files' })
hl.bind(main_mod .. ' + F', hl.dsp.exec_cmd 'firefox-developer-edition || firefox-devedition', { description = 'Open Firefox Developer Edition' })
...
-- hl.bind(hyper_mod .. ' + U ', hl.dsp.exec_cmd '/usr/lib/hyprwhspr/config/hyprland/hyprwhspr-tray.sh record')
hl.bind('Insert', hl.dsp.exec_cmd '/usr/lib/hyprwhspr/config/hyprland/hyprwhspr-tray.sh record')
...
-- )
-- hl.bind('Insert', hl.dsp.exec_cmd 'fish ~/.config/fish/scripts/whisper-live-translate.fish', { description = 'Toggle live translation' })
