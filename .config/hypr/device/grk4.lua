-- Source for generated device/grk4.conf. Edit this file, then run ./scripts/render-lua-config.sh.
return [==[
...
#
# # Top Right Monitor
# monitor=DP-1, 1920x1080@60, 1920x0, 1.0
#
# # Bottom Centered Laptop Monitor
# # x=960 pushes it to the middle of the two monitors above it
# monitor=eDP-1, 3840x2160@60, 960x1080, 2.0
#
